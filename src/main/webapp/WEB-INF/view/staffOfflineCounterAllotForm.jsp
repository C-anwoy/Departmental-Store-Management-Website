...
<head>
	...
	<title>Allot Offline Counter</title>
		...
		<div id="loginbox" style="margin-top: 50px;"
			...
			<div class="panel panel-primary">
				...
				<div class="panel-heading">
					<div class="panel-title">Allot Offline Counter</div>
				</div>

				<div style="padding-top: 30px" class="panel-body">

					<!-- Registration Form -->
					<form action="${pageContext.request.contextPath}/admin/processOfflineCounterAllotment" 

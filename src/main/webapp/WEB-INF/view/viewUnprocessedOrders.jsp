            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <table id="vendors">
							  ...
							  <c:url var="showproductLink" value="/admin/viewProductsInOrder">
							  			
							  		<c:param name="orderId" value="${temp.id}" />
							  		
							  </c:url>
							  
							  <c:url var="assignCounterLink" value="/admin/assignOnlineCounter">
							    ...
							    <td>
							    	...
							    	<a href="${assignCounterLink}" class="primary-btn cart-btn">Assign Counter</a>

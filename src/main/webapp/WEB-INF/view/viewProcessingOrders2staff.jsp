            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <table id="vendors">
							  ...
							  <c:url var="showproductLink" value="/staff/viewProductsInOrder">
							  			
							  		<c:param name="orderId" value="${temp.id}" />
							  		
							  </c:url>
							  <c:url var="processOrderLink" value="/staff/processOrder">
							    ...
							    <td>
							    	<!-- display the showProduct link -->
							    	<a href="${showproductLink}" class="primary-btn cart-btn">View Products</a>
							    	<a href="${processOrderLink}" class="primary-btn cart-btn">Process Order</a>

                        ...
                        <table>
                            ...
                            <tbody>
                            	<c:forEach var="temp" items="${products}">
                            		<c:url var="deleteLink" value="/customer/removeFromCart">
							  			
							  			<c:param name="productId" value="${temp.p.primaryKey.product.id}" />
							  		
							  		</c:url>
							  		
							  		<c:url var="incquantityLink" value="/customer/increaseQty">
							  			
							  			<c:param name="productId" value="${temp.p.primaryKey.product.id}" />
							  		
							  		</c:url>
							  		<c:url var="dcrquantityLink" value="/customer/decreaseQty">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="shoping__checkout">
                        ...
                        <a href="${pageContext.request.contextPath}/customer/toPayment" class="primary-btn">PROCEED TO CHECKOUT</a>
                    </div>
                </div>
            </div>
        </div>

            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <table id="vendors">
							  ...
							  <c:url var="updateLink" value="/admin/showFormForUpdateVendor">
							  			
							  		<c:param name="vendorId" value="${temp.id}" />
							  		
							  </c:url>
							  
							  <c:url var="supplyLink" value="/admin/addSupply">
							  			
							  		<c:param name="vendorId" value="${temp.id}" />
							  		
							  </c:url>
							  
							  <c:url var="viewsupplyLink" value="/admin/viewSupply">
							  			
							  		<c:param name="vendorId" value="${temp.id}" />
							  		
							  </c:url>
							  
							  <!-- construct an delete "link" with vendor id -->
							  
							  <c:url var="deleteLink" value="/admin/deleteVendor">
							    ...
							    <td>
							    	...
							    	<a href="${updateLink}" class="primary-btn cart-btn">Update Details</a>
							    	
							    	<!-- display the supply link -->
							    	<a href="${supplyLink}" class="primary-btn cart-btn">Add New Supply</a>
							    	
							    	<!-- display the supply link -->
							    	<a href="${viewsupplyLink}" class="primary-btn cart-btn">View Supplies</a>

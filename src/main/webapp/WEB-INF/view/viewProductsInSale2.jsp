...
<head>
    ...
    <title>Products in the Sale</title>
                ...
                <div class="col-lg-12">
                    ...
                    <table id="vendors">
						...
						<c:forEach var="temp" items="${products}">
							  	...
							  	<tr>
							    <td>${temp.primaryKey.product.id}</td>
							    <td>${temp.primaryKey.product.productName}</td>
							    <td>${temp.primaryKey.product.productDes}</td>
							    <td>${temp.primaryKey.product.brand.brandName}</td>
							    <td>${temp.primaryKey.product.MRP}</td>
							    <td>${temp.quantity}</td>
							    <td><b>Rs. ${temp.quantity * temp.primaryKey.product.MRP}</b></td>

    ...
    <section class="checkout spad">
        <div class="container">
            ...
            <div class="checkout__form">
                ...
                <form action="${pageContext.request.contextPath}/customer/placeOrder_e" method="POST">
                        ...
                        <div class="col-lg-6 col-md-8">
                            <div class="checkout__order">
                                ...
                                <div class="checkout__input__checkbox">
  									...
  									<input required type="number" id="acNo" name="acNo" min="100000000" placeholder="Account Number"><br><br>
  									
  									<input required type="text" id="bankName" name="bankName" placeholder="Name of the Bank"><br><br>
  									
  									<input required type="text" id="branchName" name="branchName" placeholder="Branch Name"><br><br>
 									
  									<input required type="text" id="ifsc" name="ifsc" placeholder="IFSC Code"><br><br>
                                </div>

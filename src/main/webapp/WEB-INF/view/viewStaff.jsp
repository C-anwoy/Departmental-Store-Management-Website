                ...
                <div class="col-lg-12">
                    ...
                    <table id="vendors">
							  <tr>
							    <th>Staff Id</th>
							    <th>Staff Name</th>
							    <th>Online Counter Id</th>
							    <th>Offline Counter Id</th>
							    <th>Street</th>
							    <th>City</th>
							    <th>PIN Code</th>
							    <th>State</th>
							  ...
							  <c:forEach var="temp" items="${staffs}">
							  
							  <!-- construct an update "link" with vendor id -->
							  
							  <c:url var="updateLink" value="/admin/showFormForUpdateStaff">
							  			
							  		<c:param name="staffId" value="${temp.userName}" />
							  		
							  </c:url>
							  
							  
							  <c:url var="allotOnlineCounterLink" value="/admin/allotOnlineCounter">
							  			
							  		<c:param name="staffId" value="${temp.userName}" />
							  		
							  </c:url>
							  <c:url var="allotOfflineCounterLink" value="/admin/allotOfflineCounter">
							  	...
							  	<tr>
							    <td>${temp.userName}</td>
							    <td>${temp.firstName} ${temp.middleName} ${temp.lastName}</td>
							    <td>${temp.onlineCounter.id}</td>
							    <td>${temp.offlineCounter.id}</td>
							    <td>${temp.street}</td>
							    <td>${temp.city}</td>
							    <td>${temp.pin}</td>
							    <td>${temp.state}</td>
							    ...
							    <td>
							    	<a href="${allotOnlineCounterLink}" class="primary-btn cart-btn">Allot Online Counter</a><br><br>
							    	
							    
							    	<a href="${allotOfflineCounterLink}" class="primary-btn cart-btn">Allot Offline Counter</a>
							    </td>
							  </tr>
					    </c:forEach>
					</table>
    ...
    <footer class="footer spad">
      ...
      <!-- Footer Section End -->
    	...
    	<table>
				...
				<c:forEach var="tempCustomer" items="${categories}">
								
					
					<tr>
						<td> ${tempCustomer.id} </td>
						<td> ${tempCustomer.catName} </td>

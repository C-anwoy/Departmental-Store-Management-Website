                ...
                <div class="col-lg-12">
                    ...
                    <table id="vendors">
							  ...
							  <c:forEach var="temp" items="${products}">
							   ...
							   <!-- construct an add to cart "link" with product id -->
							  
							  <c:url var="addtocartLink" value="/staff/addtocart">
							    ...
							    <td>
							    	...
							    	<a href="${addtocartLink}" class="primary-btn cart-btn">Add to Cart</a>
							    </td>
